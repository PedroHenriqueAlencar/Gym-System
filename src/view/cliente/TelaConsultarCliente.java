...
public class TelaConsultarCliente extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(validarJRadio() > 0)
        {
            ...
            Pessoa pessoa = pessoaDAO.getPessoa(jTextField1.getText(), mode);
            if(pessoa.getPersonal() == 0)
            {
            ...
            {
                JOptionPane.showMessageDialog(null,"Você tentou buscar um funcionário, tente novamente!");
            }
        }
