...
public class TelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sobre Gym-System");
        setResizable(false);

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("\t\tGym-System\n\nVersão: a1.0\n\nPrograma desenvolvido como requisito avaliativo\nAB3 das Disciplinas:\n- Programação de Soluções Computacionais\n- Modelagem de Software.\n\nProfessores:\n- Ana Cleyge Silva de Azevedo\n- Emerson Santos de Oliveira\n- Jairo Luciano Rêgo\n\nDesenvolvedores:\n- Guilherme Alves Ferreira\n- Jenyffer Bastos Sacramento\n- Pedro Henrique Torres de Alencar\n\nUniversidade Salvador (UNIFACS)\n\nO programa foi desenvolvido para ajudar a\ngerenciar uma academia. Possui controle\nde funcionário, cliente, mensalidade e métricas.");
